...
implementation{
	...
	command error_t Init.init(){
		...
		if (POSITION_VAL(USART2_TX_PIN) < 0x00000008U) LL_GPIO_SetAFPin_0_7(USART2_TX_GPIO_PORT, USART2_TX_PIN, LL_GPIO_AF_7);
		else LL_GPIO_SetAFPin_8_15(USART2_TX_GPIO_PORT, USART2_TX_PIN, LL_GPIO_AF_7);
		...
		if (POSITION_VAL(USART2_RX_PIN) < 0x00000008U) LL_GPIO_SetAFPin_0_7(USART2_RX_GPIO_PORT, USART2_RX_PIN, LL_GPIO_AF_7);
		else LL_GPIO_SetAFPin_8_15(USART2_RX_GPIO_PORT, USART2_RX_PIN, LL_GPIO_AF_7);
